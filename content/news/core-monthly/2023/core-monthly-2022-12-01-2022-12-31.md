...
Core components written in Vue 2 are now fully migrated to Vue 3. You can see the migration details in [this massive pull request](https://github.com/PrestaShop/PrestaShop/pull/28463). Kudos to [@NeOMakinG](https://github.com/NeOMakinG) for such amazing work!

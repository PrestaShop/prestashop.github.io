...
Release of the autoupgrade module, what's next for PrestaShop 8, the release of the 1.7.8.8, an overview of ongoing work, and much more. This Core Monthly summarizes what happened in the project during the month of December.

![Core Monthly banner](/assets/images/theme/banner-core-monthly-wide.jpg)

Dear developers,

Welcome to the first Core Monthly of 2023! 2022 was a fantastic year for the PrestaShop project, with [a new major release](/news/2022/prestashop-8-0-0-available/), [announcement of the upcoming new theme](/news/2022/new-theme-announce/) for PrestaShop, and significant changes to the project's structure, which made it more open than it ever was.
...
I understand that some of you are waiting for the first patch to start thinking about the upgrade. The good news is that both the autoupgrade module and the patch versions are very very close to being fully available.

### Autoupgrade module

Speaking of upgrades, [autoupgrade v4.15 is now live](https://github.com/PrestaShop/autoupgrade/releases/tag/v4.15.0). As I'm writing this article, PrestaShop 8 is not available in the module interface, but the module itself has everything needed for the upgrade to succeed. If you don’t see PrestaShop 8 as a new major release, you can upgrade to the latest version using the `Local archive` or `Local directory` option.

The release, along with the .xml file required by the module, [is available on GitHub](https://github.com/PrestaShop/PrestaShop/releases/tag/8.0.0) and if you don’t know how to use these options, [you can watch a short demo](https://youtu.be/SBz7lApJ_pA?t=1063) of the process that I showed during the Public Demo.
...
Thanks to [@Hlavtox](https://github.com/Hlavtox), in PrestaShop 8.1, it will be possible to enable performance metrics in the front office directly from the back office. There's still some work to do regarding this feature, as the community feedback was to add an extra security layer to let only shop maintainers see the results of profiling. You can see the [details in the pull request](https://github.com/PrestaShop/PrestaShop/pull/30603).

**Update from Vue 2 to Vue 3**

Thanks to [@NeOMakinG](https://github.com/NeOMakinG), core components written in Vue 2 are now fully migrated to Vue 3. You can see [this massive pull request](https://github.com/PrestaShop/PrestaShop/pull/28463) to see the migration details. Kudos to [@NeOMakinG](https://github.com/NeOMakinG) for such amazing work!
...
If you need help with contributing or have questions about it, feel free to contact me on the [project's Slack](https://www.prestashop-project.org/slack/) (@kpodemski).

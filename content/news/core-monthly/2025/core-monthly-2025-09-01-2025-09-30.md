...
### PrestaShop 9: Patch in progress and a Call for contributions: Admin API
...
At the same time, the ["Call for Contributions"]({{< relref "/news/posts/2025/call-for-contributions-admin-api" >}}) for the Admin API has been a great success. We are thrilled to see so many of you getting involved and contributing to the future of the PrestaShop API.
...
Special mention for [@Progi1984](https://github.com/Progi1984) and [@Codencode](https://github.com/Codencode) for contributing the first merged endpoints, including those for `Tab`, `Zone`, `WebserviceKey`, and `categories`.
...
A new version of the [Update Assistant](https://github.com/PrestaShop/autoupgrade) module is now available and ready for the upcoming PrestaShop 9.0.1.

### PrestaShop Developer Conference 2025: The agenda is coming!

A quick update on the [PrestaShop Developer Conference 2025](https://events.prestashop.com/content/developer-conference). The call for speakers is now closed, and we have selected the speakers. The agenda will be shared in October, and registration will open at the same time. We can't wait to see you there!

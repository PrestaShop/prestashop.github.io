...
You can find the complete explanation and examples in the dedicated documentation [here](https://github.com/PrestaShopCorp/prestashop-classic/wiki/Classic-version-numbers).

---
layout: post
title: "Do You Speak PrestaShop? – June 2023 Edition"
subtitle: "Where you'll learn that PrestaShop 8.1 is available in 8 languages"
date: 2023-07-07
authors: [LéaDelin]
icon: icon-world
...
Contributing to PrestaShop is not only about the code, it's also about taking part in the [PrestaShop translation project](https://crowdin.com/project/prestashop-official)! This report will tell you how the software translations evolved in June.
...
If you didn’t know, you can help translate the [PrestaShop 8 documentation](https://docs.prestashop-project.org/welcome/) into your own language! 
For now, the PrestaShop 8 docs are only available in English and French, but if you wish to help translate it, let me know. Your help is always welcome! 🙌

If you wish to learn more about how to contribute to doc translations, check out the [Translator’s documentation](https://docs.prestashop-project.org/translating-prestashop/translating-prestashop-software-basics/translating-documentation)!
...
If you're interested in becoming a proofreader, [send me a message on Crowdin](https://crowdin.com/profile/lea.delin) or on Slack! 📨
...
That's why I'd like to thank [domagtom](https://crowdin.com/profile/domagtom/), [Roman Sekeres](https://crowdin.com/profile/roman.seko/), [Wongcie Cahyono](https://crowdin.com/profile/wongciecahyono) and [Dmytro Zvieriev](https://crowdin.com/profile/biogent), as well as [KateNong](https://crowdin.com/profile/katenong/activity) who rushed into the efforts immediately!
...
* A total of **74,583 words have been translated** and **75,228 validated**. 
(That's about as many words as Phillip K. Dick's *Do Androids Dream of Electric Sheep?*, congrats!) 🎉

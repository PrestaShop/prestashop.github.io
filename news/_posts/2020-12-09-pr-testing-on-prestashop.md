...
- An issue should be linked to the PR. Each bug has to be analyzed before fixing it. This helps the team to answer several questions : Is this really a bug ? What is the severity (see [Severity Matrix](https://docs.google.com/document/d/1mcwEj7WxoGWOZqmXyuw1lQtRM1hl-jyjp9ZXgG72f4I/edit?usp=sharing)) ? What behavior is expected ? On which branch should it be fixed ?

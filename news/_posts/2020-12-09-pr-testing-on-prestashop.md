...
If we don't find any issue during our test, then we change the label to “QA Approved”. This allows the maintainers to finally merge the PR in the branch. The change will be available on PrestaShop in the next build of the branch!

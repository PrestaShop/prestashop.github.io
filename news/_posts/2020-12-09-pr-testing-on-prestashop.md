...
## 1.2 - How do you choose which PR should be tested first ?
...
## 1.3 - How long does it take to test a PR ?
...
## 1.4 - Why does my PR have both the “Waiting for author” and “Waiting for QA” labels  ?
...
- An issue should be linked to the PR. Each bug has to be analyzed before fixing it. This helps the team to answer several questions : Is this really a bug ? What is the severity [Add Matrice Link] ? What behavior is expected ? On which branch should it be fixed ?
...
## 2.3 - Check the PR fixes the bug in the issue
...
This is the most important part of our work : Usually, the nominal test is OK, and has already been tested by the developer who created the PR.
...
## 2.5 - What happens if we find some bugs ?
...
## 3.2 - Check that the improvement works accordingly to the issue and specification

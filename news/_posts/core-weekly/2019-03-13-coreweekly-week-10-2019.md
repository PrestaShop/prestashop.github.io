...
Each nighht, a new build is created with the newly merged code. Then, the automatic tests are running for this build, and a report is created. It will help contributors to improve the quality of PrestaShop.

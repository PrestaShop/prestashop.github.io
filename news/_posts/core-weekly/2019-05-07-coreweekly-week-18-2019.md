...
And, that doesn't list the work being done on the module: it is just for the core. You can take some inspiration from the links in the next section of this core weekly to track the work done on the entire project.
...
* [#28](https://github.com/PrestaShop/productcomments/pull/28): Add Readme and License, by [@eternoendless](https://github.com/eternoendless)

...
The kanban for `1.7.7` branch is not empty yet, it still contains unresolved regressions reported on version 1.7.7.0. The next delivery of bugfixes for 1.7.7 will be delivered in patch version 1.7.7.2.

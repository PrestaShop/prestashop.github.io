...
* [pagesnotfound](https://github.com/PrestaShop/pagesnotfound): [v2.0.2](https://github.com/PrestaShop/pagesnotfound/releases/tag/v2.0.2)
* [statsbestcategories](https://github.com/PrestaShop/statsbestcategories): [v2.0.1](https://github.com/PrestaShop/statsbestcategories/releases/tag/v2.0.1)
* [statsbestproducts](https://github.com/PrestaShop/statsbestproducts): [v2.0.1](https://github.com/PrestaShop/statsbestproducts/releases/tag/v2.0.1)
* [statscarrier](https://github.com/PrestaShop/statscarrier): [v2.0.1](https://github.com/PrestaShop/statscarrier/releases/tag/v2.0.1)
* [statscheckup](https://github.com/PrestaShop/statscheckup): [v2.0.2](https://github.com/PrestaShop/statscheckup/releases/tag/v2.0.2)
* [statspersonalinfos](https://github.com/PrestaShop/statspersonalinfos): [v2.0.4](https://github.com/PrestaShop/statspersonalinfos/releases/tag/v2.0.4)
* [statsproduct](https://github.com/PrestaShop/statsproduct): [v2.1.1](https://github.com/PrestaShop/statsproduct/releases/tag/v2.1.1)
* [statsregistrations](https://github.com/PrestaShop/statsregistrations): [v2.0.1](https://github.com/PrestaShop/statsregistrations/releases/tag/v2.0.1)
* [statssearch](https://github.com/PrestaShop/statssearch): [v2.0.2](https://github.com/PrestaShop/statssearch/releases/tag/v2.0.2)

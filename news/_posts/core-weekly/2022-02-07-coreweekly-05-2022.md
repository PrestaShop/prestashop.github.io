...
The project’s [first session](https://build.prestashop.com/news/public-oss-demo-1-2022/) of this year edition of our public demo was held and streamed live last week on February 2, 2022.

As PrestaShop 8 draws closer and closer, the maintainer team believes the [reworking](https://github.com/PrestaShop/PrestaShop/issues/14770) of the back-office product page is quite complete. It is now complete enough and allows us to announce the end-of-life of the previous product page.

**This means from today, no new contributions targeting the current product page will be accepted as this code is expected to disappear soon, replaced by the new version.**

If you did not know about this rework, you can discover it through [this public demo](https://www.youtube.com/watch?v=MQzTL1J5oGQ&t=1140s) and [this one](https://www.youtube.com/watch?v=ydSIyOmQez8&t=380s) on YouTube. A summary article should also be published on this blog in the next months.

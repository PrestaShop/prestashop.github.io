...
The entire team is working hard on PrestaShop version 8, with a [freeze date](https://en.wikipedia.org/wiki/Freeze_(software_engineering)) planned for mid-May - this is why we decided to cancel our May Public Demo to focus on the release, and then present the community with amazing demos in June.

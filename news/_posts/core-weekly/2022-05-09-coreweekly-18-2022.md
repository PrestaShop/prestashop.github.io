...
Finally, [committer role](https://github.com/PrestaShop/open-source/pull/79) was introduced to the project, a new role similar to maintainer that should allow contributors willing to help reviewing and triaging contributions to join the group effort.

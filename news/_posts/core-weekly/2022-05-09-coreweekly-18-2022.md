...
This week begins with two interesting pieces of news.

First, PrestaShop [1.7.8.6](https://github.com/PrestaShop/PrestaShop/issues/27973) release moved to Validation stage. For three weeks the maintainers team have been exploring and fixing multiple issues to build this stable patch version. We have high hopes that this patch version filled with very nice bug fixes can be delivered soon!

[Committer role](https://github.com/PrestaShop/open-source/pull/79) was introduced to the project, a new role similar to maintainer that should allow contributors willing to help reviewing and triaging contributions to join the group effort.

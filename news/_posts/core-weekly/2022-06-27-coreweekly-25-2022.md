...
The ongoing work on security for PrestaShop software continues. The maintainers team identified and fixed a new security issue on module [Blockwishlist](https://github.com/PrestaShop/blockwishlist/).

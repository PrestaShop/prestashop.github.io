...
[PrestaShop 8 is available!](https://build.prestashop-project.org/news/prestashop-8-0-0-available/) This is important moment for everyone involved in the project. All project members would like to thank the community for their involvement in this new version.

The Hummingbird theme maintainers team decided to [release an early version of it](https://github.com/PrestaShop/hummingbird/releases). If you are working with PrestaShop themes, this is a great chance to get your hands on it to see what the future holds.
...
Last but not least, October was the last month of such Core Weekly summaries. Starting in November, we will gather information about the project to be published in the _Core Monthly_ summary at the beginning of December. We believe this new format will be easier for everyone to track and allow us to provide you with more relevant information about the project.

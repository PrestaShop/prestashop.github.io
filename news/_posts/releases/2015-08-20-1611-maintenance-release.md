...
* The imported has been improved in various places.
...
* The module is now also available in the following languages: BG, BR, CS, ES, FA, HR, IT, LT, NO, PL, PT, QC, RO, RU, SI, SV.
...
* actionCustomerLogoutBefore and actionCustomerLogoutAfter have been added.
* ...and many more!

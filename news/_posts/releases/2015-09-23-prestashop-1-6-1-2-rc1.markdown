...
As mentionned in the [previous Core Weekly report](http://build.prestashop.com/news/coreweekly-35-36/), the team is working on a second patch version of 1.6.1.0 (meaning: on version 1.6.1.2).
...
Of particular interest is the fact that this version fixes a long-standing issue of slowness in the back-office. We really, really, really need your feedback on this one! Is it really fixed in all situations? Does your slowness issue remain the same? Let us know [on this Forge ticket](http://forge.prestashop.com/browse/PSCSX-6601)!
...
You can also use the 1-Click Upgrade module, on the RC channel :)

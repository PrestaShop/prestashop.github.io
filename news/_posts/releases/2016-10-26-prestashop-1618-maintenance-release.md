...
Furthermore, other browsers should soon follow suite: <a href="https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest/open#Parameters">Firefox has also deprecated the the `async` parameter</a>. We do not have yet an ETA for other browsers.
...
Also, **make sure that your modules and themes DO NOT make use of synchronous XHR calls**! <a href="https://developers.google.com/web/updates/2012/01/Getting-Rid-of-Synchronous-XHRs">Learn how here</a>!

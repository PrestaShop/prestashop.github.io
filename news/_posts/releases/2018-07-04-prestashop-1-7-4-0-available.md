...
<p>If you plan to upgrade, we recommend you to use the version 4.0 of the 1-click upgrade, currently [available as a beta on GitHub](https://github.com/PrestaShop/autoupgrade/releases/download/v4.0.0-beta.3/autoupgrade-v4.0.0-beta.3.zip), instead of the version 3.0 available on the marketplace.</p>
</div>
